...
########################################################
#### Connection bluetooth devies to hci0
### 
# # 0 and 1
# sleep 1
# rfcomm -i hci0 release 0 & rfcomm -i hci0 release 1
# sleep 1
# rfcomm -i hci0 connect 0 & rfcomm -i hci0 connect 1

# # 2 and 3
# sleep 1
# rfcomm -i hci0 release 2 & rfcomm -i hci0 release 3
# sleep 1
# rfcomm -i hci0 connect 2 & rfcomm -i hci0 connect 3

# # # 0 and 1 # # 2 and 3
# sleep 1
# rfcomm -i hci0 release 0 & rfcomm -i hci0 release 1 & rfcomm -i hci0 release 2 & rfcomm -i hci0 release 3
# sleep 1
# rfcomm -i hci0 connect 0 & rfcomm -i hci0 connect 1 & rfcomm -i hci0 connect 2 & rfcomm -i hci0 connect 3
#


########################################################
#### Connection bluetooth devies to hci1
####
# # for hci1
# # # 0 and 1 # # 2 and 3
# sleep 1
# rfcomm -i hci1 release 0 & rfcomm -i hci1 release 1 & rfcomm -i hci1 release 2 & rfcomm -i hci1 release 3
# sleep 1
# rfcomm -i hci1 connect 0 & rfcomm -i hci1 connect 1 & rfcomm -i hci1 connect 2 & rfcomm -i hci1 connect 3
